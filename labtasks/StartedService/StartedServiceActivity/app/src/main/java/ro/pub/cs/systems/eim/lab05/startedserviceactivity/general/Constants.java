...
public interface Constants {
    ...
    final public static String SERVICE_PACKAGE = "ro.pub.cs.systems.eim.lab05.startedservice";
    final public static String SERVICE_CLASS = "ro.pub.cs.systems.eim.lab05.startedservice.service.StartedService";
